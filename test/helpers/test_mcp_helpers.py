...
class TestMCPSessionManager:
    ...
    def test_init(self):
        ...
        manager = MCPSessionManager(
            server_url="https://example.com/mcp", api_key="test_key"
        )
...
class TestMCPSessionManagerContextManager:
    ...
    async def test_mcp_session_manager_streamable_http(
        self, mock_client_session, mock_streamable_client
    ):
    ...
    @patch("mellea.helpers.mcp_helpers.ClientSession")
    async def test_mcp_session_manager_sse(self, mock_client_session, mock_sse_client):
...
class TestGetCurrentMCPSession:
    ...
    async def test_get_current_mcp_session_active(
        self, mock_initialize, mock_client_session, mock_streamable_client
    ):
